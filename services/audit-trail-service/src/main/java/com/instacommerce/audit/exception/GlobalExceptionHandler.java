package com.instacommerce.audit.exception;

import com.instacommerce.audit.dto.ErrorDetail;
import com.instacommerce.audit.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleApiException(ApiException ex, HttpServletRequest request) {
        return ResponseEntity.status(ex.getStatus())
                .body(buildError(ex.getCode(), ex.getMessage(), List.of()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex,
        ...
        return ResponseEntity.badRequest()
                .body(buildError("VALIDATION_ERROR", "Invalid input", details));
    }
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(buildError("ACCESS_DENIED", "Insufficient permissions", List.of()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleReadable(HttpMessageNotReadableException ex,
                                                        HttpServletRequest request) {
        return ResponseEntity.badRequest()
                .body(buildError("VALIDATION_ERROR", "Invalid input", List.of()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleFallback(Exception ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(buildError("INTERNAL_ERROR", "An unexpected error occurred", List.of()));
    }
