...
import com.instacommerce.catalog.dto.response.ErrorDetail;
import com.instacommerce.catalog.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRateLimit(RequestNotPermitted ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS)
            .body(buildError("RATE_LIMIT_EXCEEDED", "Too many requests. Try again later.", List.of(), request));
    }
