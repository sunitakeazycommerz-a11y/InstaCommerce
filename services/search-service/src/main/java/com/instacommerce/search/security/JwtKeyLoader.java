package com.instacommerce.search.security;
...
public class JwtKeyLoader {
    ...
    public JwtKeyLoader(SearchProperties searchProperties) {
        this.publicKey = (RSAPublicKey) parsePublicKey(searchProperties.getJwt().getPublicKey());
    }
