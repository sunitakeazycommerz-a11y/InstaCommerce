...
import com.instacommerce.pricing.domain.OutboxEvent;
import com.instacommerce.pricing.repository.OutboxEventRepository;
...
public class OutboxService {
    ...
    public void recordEvent(String aggregateType, String aggregateId, String eventType, Object payload) {
        recordEvent(aggregateType, aggregateId, eventType, payload, null);
    }

    @Transactional(propagation = Propagation.MANDATORY)
    public void recordEvent(String aggregateType, String aggregateId, String eventType,
